...
// Widget storeproducts(title,subTitle,category,image,products){
//   return Card(
//     child:  Row(
...
//              Navigator.pushReplacementNamed(context, AddProduct.routeName,arguments: products)
//            },
//            child: Text(
//              "Edit",
...
//     oktext: "Delete",
//     okFunc: (){
//       Provider.of<ProviderShop>(context,listen:false).deleteProduct(context,products.sId);
//     },cancelText: "Cancel")
